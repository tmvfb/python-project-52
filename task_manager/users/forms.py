...
class RegistrationForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["username"].widget.attrs.update(
            {"maxlength": "50", "class": "form-control", "placeholder": _("Username")}  # noqa: E501
        )
        self.fields[
            "username"
        ].help_text = _("Required. 50 characters or fewer. Letters, digits and @/./+/-/_ only.")  # noqa: E501
    ...
    class Meta(UserCreationForm.Meta):
        ...
        model = User
        fields = ["first_name", "last_name", "username", "password1", "password2"]  # noqa: E501
